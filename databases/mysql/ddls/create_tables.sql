...
CREATE TABLE PROCESS_PERMISSION (
  ...
  OWNER_R TINYINT(1) DEFAULT 1,
  OWNER_W TINYINT(1) DEFAULT 1,
  OWNER_X TINYINT(1) DEFAULT 1,
  GROUP_R TINYINT(1) DEFAULT 0,
  GROUP_w TINYINT(1) DEFAULT 0,
  GROUP_X TINYINT(1) DEFAULT 0,
  OTHER_R TINYINT(1) DEFAULT 0,
  OTHER_W TINYINT(1) DEFAULT 0,
  OTHER_X TINYINT(1) DEFAULT 0,
  PRIMARY KEY(PROCESS_ID),
CONSTRAINT FK_USERROLEID FOREIGN KEY (ROLE) REFERENCES USER_ROLES (USER_ROLE_ID),
CONSTRAINT FK_OWNER FOREIGN KEY (OWNER) REFERENCES USERS (USERNAME),
CONSTRAINT FK_PERMISSIONPROCESSID FOREIGN KEY (PROCESS_ID) REFERENCES PROCESS (PROCESS_ID)
) ENGINE=INNODB DEFAULT CHARSET=UTF8;
